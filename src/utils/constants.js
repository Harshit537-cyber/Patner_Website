...
export const ONBOARDING_STEPS = [
  { key: 'personal', label: 'Personal Details', path: '/onboarding/personal-details' },
  { key: 'professional', label: 'Professional Details', path: '/onboarding/professional-details' },
  { key: 'kyc', label: 'KYC', path: '/onboarding/kyc' },
  { key: 'documents', label: 'Documents', path: '/onboarding/documents' },
  { key: 'bank', label: 'Bank Details', path: '/onboarding/bank-details' },
];
...
export const WEBSITE_NAV = [
  ...
  { label: 'Earnings', path: '/earnings-info' },
  { label: 'FAQ', path: '/faq' },
